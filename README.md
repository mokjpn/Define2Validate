...
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |nchar(as.character(LBORRES)) <= 8                                                                                                     |
...
|Length of LBORRES                           |     6|      5|     1|   0|FALSE |FALSE   |(!(LBTESTCD == "BILI" & LBCAT == "CHEMISTRY" & LBSPEC == "BLOOD")) &#124; nchar(as.character(LBORRES)) <= 3                           |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "BUN" & LBCAT == "CHEMISTRY" & LBSPEC == "BLOOD")) &#124; nchar(as.character(LBORRES)) <= 4                            |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "GLUC" & LBCAT == "CHEMISTRY" & LBSPEC == "BLOOD")) &#124; nchar(as.character(LBORRES)) <= 3                           |
|Length of LBORRES                           |     0|      0|     0|   0|TRUE  |FALSE   |(!(LBTESTCD == "GLUC" & LBCAT == "URINALYSIS" & LBSPEC == "URINE" & LBMETHOD == "DIPSTICK")) &#124; nchar(as.character(LBORRES)) <= 8 |
|Length of LBORRES                           |     0|      0|     0|   0|TRUE  |FALSE   |(!(LBTESTCD == "GLUC" & LBCAT == "URINALYSIS" & LBSPEC == "URINE" & LBMETHOD == "QUANT")) &#124; nchar(as.character(LBORRES)) <= 8    |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "HCT" & LBCAT == "HEMATOLOGY" & LBSPEC == "BLOOD")) &#124; nchar(as.character(LBORRES)) <= 4                           |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "HGB" & LBCAT == "HEMATOLOGY" & LBSPEC == "BLOOD")) &#124; nchar(as.character(LBORRES)) <= 4                           |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "LYM" & LBCAT == "HEMATOLOGY" & LBSPEC == "BLOOD")) &#124; nchar(as.character(LBORRES)) <= 4                           |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "OCCBLD" & LBCAT == "URINALYSIS" & LBSPEC == "URINE")) &#124; nchar(as.character(LBORRES)) <= 8                        |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "PH" & LBCAT == "URINALYSIS" & LBSPEC == "URINE")) &#124; nchar(as.character(LBORRES)) <= 3                            |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "VITB12" & LBCAT == "CHEMISTRY" & LBSPEC == "SERUM")) &#124; nchar(as.character(LBORRES)) <= 3                         |
|LBORRES should be integer                   |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "VITB12" & LBCAT == "CHEMISTRY" & LBSPEC == "SERUM")) &#124; regexpr("^[0-9-]+$", as.character(LBORRES)) == 1          |
|Length of LBORRES                           |     6|      6|     0|   0|FALSE |FALSE   |(!(LBTESTCD == "VITB9" & LBCAT == "CHEMISTRY" & LBSPEC == "BLOOD")) &#124; nchar(as.character(LBORRES)) <= 5                          |
